...
ALTER TABLE public.proccessed_content_table ADD CONSTRAINT proccessed_content_table_pk PRIMARY KEY (id);
...
ALTER TABLE public.proccessed_content_table ADD CONSTRAINT proccessed_content_table_unprocessed_content_table_fk FOREIGN KEY (unprocessed_id) REFERENCES public.unprocessed_content_table(id) ON DELETE CASCADE ON UPDATE CASCADE;
