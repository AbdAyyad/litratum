...
public class DeleteBackstageAdminAction implements IAction {
    @Override
    public void execute(HttpServletRequest req, HttpServletResponse resp, String jsp) throws ServletException, IOException {
        ...
        if (adminIsLoggedIn) {
            ...
            removeBackStageAdminFromUI(session, userId);
    ...
    private void removeBackStageAdminFromUI(HttpSession session, String userId) {
